...
public class RecommendedUsersRecyclerAdapter extends RecyclerView.Adapter {

    public Context context;
    public ArrayList<UserModel> userModelArrayList;

    public RecommendedUsersRecyclerAdapter(Context context, ArrayList<UserModel> userModelArrayList) {
